const sw = {
  ...
  home: {
    ...
    sellVoucher: 'Uza vocha mpya ya recharge',
    cashOutBch: 'Badili BCH kuwa fedha taslimu',
  ...
  treasuryTopUpQr: {
    title: 'QR ya kuongeza hazina',
    subtitle:
      'Scan QR code hii kutoka kwenye pochi nyingine ya BCH ili kuongeza BCH kwenye pochi ya hazina ya mfanyabiashara.',
    receiveOnlyNotice:
      'QR ya kupokea tu. Hii inamruhusu mfanyabiashara kuongeza BCH kwenye pochi ya hazina. Haitumii wala kutangaza chochote kutoka kwenye app hii.',
    qrAlt: 'QR code ya kuongeza hazina',
    ...
    copyAddress: 'Nakili anwani',
    copyPaymentUri: 'Nakili URI ya malipo',
    uriLabel: 'Kuongeza BCH kwenye hazina',
    uriMessage: 'Ongeza BCH kwenye pochi ya hazina ya mfanyabiashara',
